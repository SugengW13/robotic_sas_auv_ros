...
class Subscriber():
    def __init__(self):
        ...
        self.pid_roll = PID(1000, 20, 50)
        self.pid_pitch = PID(1000, 20, 50)
    ...
    def surge_sway_yaw(self):
        ...
        # print(pwm_thruster_1, pwm_thruster_2, pwm_thruster_3, pwm_thruster_4)
    ...
    def heave_roll_pitch(self):
        ...
        print(pwm_thruster_5, pwm_thruster_6, pwm_thruster_7, pwm_thruster_8)
        print(self.pwm_heave, self.pwm_roll, self.pwm_pitch)

    def stabilize_roll(self, error):
        self.pwm_roll = self.pid_roll(error)
        # print("pwm roll", self.pwm_roll)
        # print("roll", error)
